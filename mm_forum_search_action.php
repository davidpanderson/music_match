...
if (!count($threads) && !count($posts)){
    ...
    .tra("You can also %1 try the same search on Google. %2",
         "<a href=\"https://www.google.com/search?domains=".url_base()."&sitesearch=".url_base()."mm_forum_thread.php&q=".htmlentities($search_keywords)."\">",
         "</a>")
    ."</p>";
}
echo "<p><a href=\"mm_forum_search.php\">".tra("Perform another search")."</a></p>";
page_tail();
